    ...
    <div className="glass rounded-[2.5rem] overflow-hidden border-white/5 shadow-2xl">
      <div className="p-10 border-b border-white/5 flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white/5">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1 font-medium">Deep-dive feature recognition via automated footprint analysis.</p>
        </div>
        <div className="flex items-center space-x-6">
           <div className="flex items-center space-x-2">
             <span className="w-2.5 h-2.5 bg-emerald-500 rounded-full glow-indigo shadow-emerald-500/40"></span>
             <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Available</span>
           </div>
           <div className="flex items-center space-x-2">
             <span className="w-2.5 h-2.5 bg-amber-500 rounded-full glow-indigo shadow-amber-500/40"></span>
             <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Limited</span>
           </div>
           <div className="flex items-center space-x-2">
             <span className="w-2.5 h-2.5 bg-rose-500 rounded-full glow-indigo shadow-rose-500/40"></span>
                ...
                <td className="px-10 py-8">
                  ...
                  {item.status === 'limited' && (
                    <div className="inline-flex items-center px-4 py-1.5 rounded-full bg-amber-500/10 border border-amber-500/20 text-amber-400 text-[10px] font-black uppercase tracking-widest">
                      <i className="fa-solid fa-triangle-exclamation mr-2"></i> Beta/Limited
                    </div>
                  )}
                  {item.status === 'missing' && (
      ...
      <div className="p-8 bg-white/5 border-t border-white/5 text-center">
        <p className="text-[10px] text-slate-600 font-black uppercase tracking-[0.3em]">
          End of Comparison Report. Accuracy Confidence: 92%
        </p>
      </div>
    </div>
  );
